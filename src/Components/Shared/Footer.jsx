...
const Footer = () => {
    return (
        <footer className="px-4 pt-20 mt-[-64px] divide-y dark:bg-gray-100 dark:text-gray-800 relative z-0">
            <div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
                <div className="lg:w-1/3">
                    <a rel="noopener noreferrer" href="#" className="flex justify-center space-x-3 lg:justify-start">
                        ...
                        <span className="self-center text-2xl font-semibold">Suthraya</span>
                    </a>
                    <p className="w-56 ml-14 text-sm">Building a platform for growth and community</p>
                </div>
                <div className="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4">
                    ...
                    <div className="space-y-3">
                        <h3 className="tracking-wide uppercase dark:text-gray-900">Courses & Trainings</h3>
                        <ul className="space-y-1">
                            <li>
                                <a rel="noopener noreferrer" href="#">Technology & Innovation</a>
                            </li>
                            <li>
                                <a rel="noopener noreferrer" href="#">Physics & Science</a>
                            </li>
                            <li>
                                <a rel="noopener noreferrer" href="#">Engineering</a>
                            </li>
                            <li>
            ...
            <div className="py-6 text-sm text-center dark:text-gray-600">© 2024 Suthraya. All rights reserved.</div>
        </footer>
    );
};
